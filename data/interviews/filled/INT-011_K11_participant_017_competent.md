...
Eklemek istediğim son nokta: süreç genel olarak verimliydi ve teşekkür ettim. Görüşmenin yaklaşık 50 dakika sürdüğünü belirttim.

---

## Görüşmeci notları

K11 transkripti tematik analize alındı. Katılımcı Yetkin düzeyinde; baskın alan Pedagojik. Ortalama NASA-TLX 42, ortalama öğrenme kazanımı 14 puan. Tercih edilen mod: Benzer. Aktif kodlar: BDG, TAM, MDF. Kodlayıcılar arası uyum örneklemde Cohen κ = .84 (tez 4.5).
