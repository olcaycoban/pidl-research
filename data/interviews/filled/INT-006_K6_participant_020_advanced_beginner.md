...
**Görüşme kodu:** INT-006 · **Katılımcı:** **K6**
...
Eklemek istediğim son nokta: süreç genel olarak verimliydi ve teşekkür ettim. Görüşmenin yaklaşık 39 dakika sürdüğünü belirttim.

---

## Görüşmeci notları

K6 transkripti tematik analize alındı. Katılımcı İleri Başlangıç düzeyinde; baskın alan Pedagojik. Ortalama NASA-TLX 44, ortalama öğrenme kazanımı 14 puan. Tercih edilen mod: Benzer. Aktif kodlar: ZOR, TAM, ILE. Kodlayıcılar arası uyum örneklemde Cohen κ = .84 (tez 4.5).
