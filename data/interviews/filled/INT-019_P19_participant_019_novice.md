...
**Anonim katılımcı kodu:** **P19** (Bu görüşme: INT-019)
...
| Katılımcı Kodu (tez) | **P19** |
| Katılımcı UUID | P-791DA11F… |
| Veri seti participant_id | 19 |
| Dreyfus Seviyesi | Acemi |
| Görüşme Tarihi | 20 / 02 / 2025 |
| Saat | 13:43 – 14:25 |
| Süre | 42 dakika |
| Tür | ☑ Video konferans |
...
**Yanıt:**
Adım adım kod yazdırması işimi kolaylaştırdı özellikle Solidityde takıldığım yerlerde
...
[P19] P19 — adım adım; joint display — Acemi; ort. NASA-TLX 47 tercih mod Similar. İkinci kodlayıcı uyumu örneklem: κ=.78 (tez 4.5).

---

## Tematik kodlama (tez 4.5)

| Kod | Tema (tez alt bölümü) | P19 |
|-----|------------------------|:----------------:|
